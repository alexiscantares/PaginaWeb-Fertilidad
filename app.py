                        ...
                        if st.button("📄 Generar Interpretación e Informe NI 43-101"):
                            with st.spinner("Procesando síntesis geoquímica y consultando a Groq..."):
                                try:
                                    ...
                                    # Construir el prompt en formato String plano
                                    prompt_ni43101 = f"""
...
- Total de muestras procesadas: {total_muestras_tab}
- Muestras Fértiles (Clasificación IA): {muestras_fertiles_tab} ({porcentaje_anomalias_tab:.2f}% de anomalía)
